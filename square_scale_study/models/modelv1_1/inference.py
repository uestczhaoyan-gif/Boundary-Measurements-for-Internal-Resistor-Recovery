...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run inference for square_scale_study modelv1.1.")
...
def infer_from_meta(args: argparse.Namespace) -> dict:
    ...
    pred_delta = np.concatenate(preds, axis=0) if preds else np.zeros_like(y_split)
