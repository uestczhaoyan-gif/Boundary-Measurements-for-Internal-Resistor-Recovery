...
class ModelV1Regressor(nn.Module):
    def __init__(
        self,
    ...
    def forward(self, x: torch.Tensor, return_aux: bool = False):
        ...
        pred = torch.tanh(self.value_head(edge_hidden).squeeze(-1)) * self.max_abs
        if return_aux:
            return pred, {"pooled_nodes": pooled_nodes, "excitation_attn": excitation_attn}
        return pred


MinimalFixedKRegressor = ModelV1Regressor
