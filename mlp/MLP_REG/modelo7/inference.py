...
def main():
    parser = argparse.ArgumentParser(description="Inference for 64Nodes MLP-Mixer regression modelo7.")
    ...
    resolve_inference_runtime_paths(args, script_dir, "./cache_dataset_reg_mixer.npz")
    print(
        "[Runtime] "
