...
class MLPMixerClassifier(nn.Module):
    def __init__(self, num_excitations=32, in_dim=28, hidden_dim=128, trunk_dim=256, proj_dim=128, out_dim=3, dropout=0.1):
        super().__init__()
    ...
    def forward(self, x, return_aux=False):
        ...
        if return_aux:
            return logits, {"contrast_feat": F.normalize(contrast_feat, dim=-1), "features": trunk_feat}
        return logits
