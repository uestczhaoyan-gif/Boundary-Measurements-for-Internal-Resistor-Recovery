...
def parse_args():
    parser = argparse.ArgumentParser(description="64Nodes MLP full task: modelv2_h_multitask.")
    ...
    parser.add_argument("--lambda-cls-stage2-start", type=float, default=0.25)
    parser.add_argument("--lambda-cls-stage2-end", type=float, default=0.08)
    ...
    parser.add_argument("--lambda-count", type=float, default=0.6)
