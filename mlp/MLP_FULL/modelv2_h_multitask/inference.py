...
def main():
    parser = argparse.ArgumentParser(description="Inference for 64Nodes MLP full h-multitask.")
    ...
    for idx in sample_idx:
        ...
        print(f"\nSample index={idx}")
        print(
            f"True={true_count} | Pred(count head)={pred_count_head} | Pred(reg-thr)={pred_count_reg}"
        )
