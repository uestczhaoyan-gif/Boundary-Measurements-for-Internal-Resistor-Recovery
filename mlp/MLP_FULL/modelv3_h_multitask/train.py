...
def parse_args():
    parser = argparse.ArgumentParser(description="64Nodes MLP full task: modelv3_h_multitask (MAE-first, conservative).")
    ...
    parser.add_argument("--lambda-cls-stage2-end", type=float, default=0.06)
    ...
    parser.add_argument("--lambda-count", type=float, default=0.45)
