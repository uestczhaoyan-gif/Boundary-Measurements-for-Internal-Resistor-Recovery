...
def main():
    parser = argparse.ArgumentParser(description="Inference for 64Nodes CNN2D-MLP classification.")
    ...
    resolve_inference_runtime_paths(args, script_dir, "./cache_dataset_cls_v2.npz")
    ...
    model = CNN2DClassifier(in_ch=x.shape[1], out_dim=NUM_CLASSES - 1).to(device)
