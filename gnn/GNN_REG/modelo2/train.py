...
def parse_args():
    parser = argparse.ArgumentParser(description="64Nodes physics-informed GNN regression modelo2.")
    ...
    parser.add_argument("--val-sparse-alpha", type=float, default=0.20)
