...
def compute_decoupled_losses(
    ...
    loss = mask_loss_weight * loss_mask + value_loss_weight * loss_value
...
def parse_args():
    parser = argparse.ArgumentParser(description="64Nodes physics-informed GNN regression o4b3.")
    ...
    parser.add_argument("--mask-loss-weight", type=float, default=50.0)
