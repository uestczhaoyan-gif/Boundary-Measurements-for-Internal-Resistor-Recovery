...
def resolve_dataset_runtime_paths(args, script_dir, default_cache_path):
    ...
    out_base = script_dir / "outputs" / "cls" if args.out_dir == "./outputs/cls" else Path(args.out_dir)
...
def parse_args():
    parser = argparse.ArgumentParser(description="64Nodes GNN_FULL Mv1 classifier branch.")
    ...
    parser.add_argument("--out-dir", default="./outputs/cls")
